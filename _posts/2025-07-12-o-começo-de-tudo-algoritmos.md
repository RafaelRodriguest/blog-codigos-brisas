...
Você provavelmente já ouviu alguém dizer isso e ignorou. Eu entendo.
...
Foi isso que fundamentou a ciência da computação e o conceito de algoritmo computacional: uma sequência finita de instruções, operações bem definidas e um resultado esperado.
